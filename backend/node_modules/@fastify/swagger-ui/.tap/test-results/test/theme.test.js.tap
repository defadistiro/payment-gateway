...
ok 1 - swagger route does not return additional theme # time=39.386ms
...
ok 2 - swagger route returns additional theme # time=6.717ms
...
ok 3 - swagger route returns additional theme - only js # time=5.738ms
...
# Subtest: swagger route returns additional theme - only css
    ...
    ok 3 - should be equal
    ok 4 - should be equal
ok 4 - swagger route returns additional theme - only css # time=5.054ms
...
# Subtest: swagger route returns additional theme - only favicon
    ...
    ok 4 - should be equal
    ok 5 - should be equal
ok 5 - swagger route returns additional theme - only favicon # time=6.195ms
...
# Subtest: swagger route returns additional theme - only title
    ...
    ok 2 - should match pattern
    ok 3 - should be equal
ok 6 - swagger route returns additional theme - only title # time=3.362ms
