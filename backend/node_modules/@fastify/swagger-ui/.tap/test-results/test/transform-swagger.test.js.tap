...
ok 1 - transformSpecification should modify the json # time=38.76ms
...
ok 2 - transformSpecificationClone false should not deepclone fastify.swagger() /1 # time=4.798ms
...
ok 3 - transformSpecification should modify the yaml # time=12.254ms
...
ok 4 - transformSpecificationClone false should not deepclone fastify.swagger() /2 # time=4.178ms
